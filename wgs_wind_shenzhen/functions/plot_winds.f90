  PROGRAM plot_winds
    ...
    open(9,file='sfc_wind_tmp.gs',action='write')
      ...
      if( len_file <= 15 ) then
        ...
        write(9,'(a)')  "'! convert -density 144 -resize 50% -antialias -trim "//argum(1)(1:10)//".eps "//argum(1)(1:10)//".bmp'"
        write(9,'(a)')  "'! convert -density 144 -antialias -trim "//argum(1)(1:10)//".bmp "//argum(1)(1:10)//".gif'"
