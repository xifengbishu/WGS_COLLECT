  PROGRAM plot_winds
    ...
    real, allocatable, dimension(:,:) :: u, v, slp
    ...
    open(1, file=trim(argum(1)), status='old', action='read' )
      ...
      !
      allocate( u(kx,ky), v(kx,ky), slp(kx,ky) )
      read(1,*)
      read(1,'(15f7.2)') u(:,:)
      read(1,*)
      read(1,'(15f7.2)') v(:,:)
    ...
    open(9,file='sfc_wind_tmp.gs',action='write')
      ...
      write(9,'(a)')   "'draw map '"
      write(9,'(a)')   "'set xlint 4'"
      write(9,'(a)')   "'set ylint 2'"
      write(9,'(a)')   "'set xlopts 1 6 0.16'"
      write(9,'(a)')   "'set ylopts 1 6 0.16'"
      write(9,'(a)')   "'set clopts 1 6 0.12'"
      ...
      write(9,'(a)')   "'d mag(u,v)'"
      write(9,'(a)')   "'cbarn 1.2 2'"
      write(9,'(a)')   "'set gxout vector'"
      write(9,'(a)')   "'set cmin 0'"
      write(9,'(a)')   "'set ccolor 1'"
      if( res <= 0.1 ) then
        write(9,'(a)')   "'d skip(u,8);skip(v,8)'"
      else
        write(9,'(a)')   "'d skip(u,7);skip(v,7)'"
      endif
      if( len_file == 15 ) then
      ...
      if( len_file == 15 ) then
        ...
        write(9,'(a)')  "'! convert -density 144 -antialias -trim "//argum(1)(1:11)//".eps "//argum(1)(1:11)//".bmp'"
        write(9,'(a)')  "'! convert -density 144 -antialias -trim "//argum(1)(1:11)//".bmp "//argum(1)(1:11)//".jpg'"
